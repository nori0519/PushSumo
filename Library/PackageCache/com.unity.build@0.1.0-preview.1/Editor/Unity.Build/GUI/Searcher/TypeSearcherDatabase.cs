...
namespace Unity.Build
{
    internal static class TypeSearcherDatabase
    {
        ...
        public static SearcherDatabase GetBuildSettingsDatabase(HashSet<Type> types)
        {
            return Populate<IBuildSettingsComponent>(types, null);
        }

        public static SearcherDatabase GetBuildStepsDatabase(HashSet<Type> types, Func<Type, string> displayNameResolver)
        {
