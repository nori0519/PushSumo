...
namespace Unity.Platforms.Build
{
    public sealed class ClassicBuildProfile : IBuildPipelineComponent
    {
        ...
        /// </summary>
        ///
        //TODO : This property will go away, because each build pipeline will be per platform anyways, thus build pipeline has to know its target without settings
        //       Don't make this property public!
        [HideInInspector]
        [Property]
